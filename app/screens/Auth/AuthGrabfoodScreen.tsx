...
const LoginScreen = () => {
  const [username, setUsername] = useState("dang.nguyentranhuu");
  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await loginGrabFood(username, password, user);
      console.log("Login successful:", response);

      let storeInfo = await getStoreInfo(response.data.jwt);
      if (!storeInfo) {
        storeInfo = {
          data: {
            grab_food_profile: {
              merchant: {
                ...
                helpCenterUrl: {
                  "en-kh": "https://help.grab.com/merchant/en-kh/360001717951",
                  "en-my": "https://help.grab.com/merchant/en-my/360001717951",
                  "en-ph": "https://help.grab.com/merchant/en-ph/900006612563",
                  "en-sg": "https://help.grab.com/merchant/en-sg/360001717951",
                  "en-th": "https://help.grab.com/merchant/en-th/360001717951",
                  "id-id": "https://food-merchant-help.grab.com/hc/id",
                  "my-mm": "https://help.grab.com/merchant/my-mm",
                  "th-th": "https://help.grab.com/merchant/th-th/360001717951",
                  "vi-vn": "https://help.grab.com/merchant/vi-vn/360001717951",
                },
                campaignHowItWorksUrl: {
                  ...
                  "th-th": "https://help.grab.com/merchant/th-th/360040807092",
                ...
                cancelOrderHelpCenterUrl: {
                  ...
                  "en-sg": "https://help.grab.com/merchant/en-sg/360045212172",
                  "id-id":
                  ...
                  "th-th": "https://help.grab.com/merchant/th-th/4608932986137",
                  "vi-vn":
...
const styles = StyleSheet.create({
  ...
  logoText: {
    fontSize: 30,
    color: "#2E7D32", // Grab's green color
    textAlign: "center",
    marginBottom: 30,
  },
  title: {
